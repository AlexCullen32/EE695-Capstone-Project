 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue Mar 11 16:59:36 2025
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                Motor_Direction
...
/* Input Port  0 */
#define IN_PORT_0_NAME                 Control_Output
...
extern void Motor_Direction_Outputs_wrapper(const real_T *Control_Output,
  real_T *Motor);
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Control_Output of S-Function Motor_Direction");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port Motor of S-Function Motor_Direction");
      return;
    }
...
{
  const real_T *Control_Output = (real_T *) ssGetInputPortRealSignal(S, 0);
  real_T *Motor = (real_T *) ssGetOutputPortRealSignal(S, 0);
  Motor_Direction_Outputs_wrapper(Control_Output, Motor);
}
