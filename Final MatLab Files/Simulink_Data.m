%% Parallel PID Simulink Model (WORKS WITH PHYSICAL SYSTEM, NOT JUST SIM)
...
%% PID Simulations (for Simulink Model)
...
%% Plot PID Simulation (change angle to angle1, angle2 etc for different model plots)
close all;
clc;
