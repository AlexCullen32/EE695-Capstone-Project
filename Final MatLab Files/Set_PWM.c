 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Fri Feb 28 13:32:02 2025
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                Set_PWM
...
extern void Set_PWM_Outputs_wrapper(const real_T *motor,
  real_T *IN1,
  real_T *IN2,
  real_T *PWM);
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port motor of S-Function Set_PWM");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port IN1 of S-Function Set_PWM");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port IN2 of S-Function Set_PWM");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port PWM of S-Function Set_PWM");
      return;
    }
...
{
  const real_T *motor = (real_T *) ssGetInputPortRealSignal(S, 0);
  real_T *IN1 = (real_T *) ssGetOutputPortRealSignal(S, 0);
  real_T *IN2 = (real_T *) ssGetOutputPortRealSignal(S, 1);
  real_T *PWM = (real_T *) ssGetOutputPortRealSignal(S, 2);
  Set_PWM_Outputs_wrapper(motor, IN1, IN2, PWM);
}
