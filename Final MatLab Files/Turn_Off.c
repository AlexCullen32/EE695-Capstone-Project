 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue Mar 11 18:32:52 2025
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                Turn_Off
...
/* Input Port  0 */
#define IN_PORT_0_NAME                 sensorReading
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                MotorOut
...
extern void Turn_Off_Outputs_wrapper(const uint16_T *sensorReading,
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port sensorReading of S-Function Turn_Off");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port MotorIn of S-Function Turn_Off");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port MotorOut of S-Function Turn_Off");
      return;
    }
...
{
  const uint16_T *sensorReading = (uint16_T *) ssGetInputPortRealSignal(S, 0);
  const real_T *MotorIn = (real_T *) ssGetInputPortRealSignal(S, 1);
  real_T *MotorOut = (real_T *) ssGetOutputPortRealSignal(S, 0);
  Turn_Off_Outputs_wrapper(sensorReading, MotorIn, MotorOut);
}
